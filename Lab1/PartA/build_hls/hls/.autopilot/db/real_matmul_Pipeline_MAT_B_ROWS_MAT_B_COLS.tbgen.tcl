...
dict set ap_memory_interface_dict MatB { MEM_WIDTH 2400 MEM_SIZE 60000 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ mem int 128 regular {axi_master 0}  }
	{ MatB int 2400 regular {array 200 { 0 3 } 0 1 }  }
	{ sext_ln36 int 60 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "MatA_DRAM","offset": { "type": "dynamic","port_name": "MatA_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatB_DRAM","offset": { "type": "dynamic","port_name": "MatB_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatC_DRAM","offset": { "type": "dynamic","port_name": "MatC_DRAM","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "MatB", "interface" : "memory", "bitwidth" : 2400, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sext_ln36", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ MatB_address0 sc_out sc_lv 8 signal 1 } 
	{ MatB_ce0 sc_out sc_logic 1 signal 1 } 
	{ MatB_we0 sc_out sc_lv 300 signal 1 } 
	{ MatB_d0 sc_out sc_lv 2400 signal 1 } 
	{ sext_ln36 sc_in sc_lv 60 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "MatB_we0", "direction": "out", "datatype": "sc_lv", "bitwidth":300, "type": "signal", "bundle":{"name": "MatB", "role": "we0" }} , 
 	{ "name": "MatB_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":2400, "type": "signal", "bundle":{"name": "MatB", "role": "d0" }} , 
 	{ "name": "sext_ln36", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln36", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	MatB { ap_memory {  { MatB_address0 mem_address 1 8 }  { MatB_ce0 mem_ce 1 1 }  { MatB_we0 mem_we 1 300 }  { MatB_d0 mem_din 1 2400 } } }
	sext_ln36 { ap_none {  { sext_ln36 in_data 0 60 } } }
}
