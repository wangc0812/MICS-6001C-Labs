...
dict set ap_memory_interface_dict MatC { MEM_WIDTH 16 MEM_SIZE 40000 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ mem int 128 regular {axi_master 1}  }
	{ sext_ln71 int 60 regular  }
	{ MatC int 16 regular {array 20000 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "MatA_DRAM","offset": { "type": "dynamic","port_name": "MatA_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatB_DRAM","offset": { "type": "dynamic","port_name": "MatB_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatC_DRAM","offset": { "type": "dynamic","port_name": "MatC_DRAM","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln71", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
 	{ "Name" : "MatC", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln71 sc_in sc_lv 60 signal 1 } 
	{ MatC_address0 sc_out sc_lv 15 signal 2 } 
	{ MatC_ce0 sc_out sc_logic 1 signal 2 } 
	{ MatC_q0 sc_in sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln71", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln71", "role": "default" }} , 
 	...
 	{ "name": "MatC_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "MatC", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8ns_7ns_8ns_15_4_1_U168", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln71 { ap_none {  { sext_ln71 in_data 0 60 } } }
	MatC { ap_memory {  { MatC_address0 mem_address 1 15 }  { MatC_ce0 mem_ce 1 1 }  { MatC_q0 mem_dout 0 16 } } }
}
