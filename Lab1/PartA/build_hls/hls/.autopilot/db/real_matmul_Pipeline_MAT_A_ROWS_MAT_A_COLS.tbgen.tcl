set moduleName real_matmul_Pipeline_MAT_A_ROWS_MAT_A_COLS
set isTopModule 0
...
set C_modelName {real_matmul_Pipeline_MAT_A_ROWS_MAT_A_COLS}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict MatA { MEM_WIDTH 2400 MEM_SIZE 30000 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ mem int 128 regular {axi_master 0}  }
	{ MatA int 2400 regular {array 100 { 0 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "MatA_DRAM","offset": { "type": "dynamic","port_name": "MatA_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatB_DRAM","offset": { "type": "dynamic","port_name": "MatB_DRAM","bundle": "control"},"direction": "READONLY"},{"cName": "MatC_DRAM","offset": { "type": "dynamic","port_name": "MatC_DRAM","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "MatA", "interface" : "memory", "bitwidth" : 2400, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ MatA_address0 sc_out sc_lv 7 signal 1 } 
	{ MatA_ce0 sc_out sc_logic 1 signal 1 } 
	{ MatA_we0 sc_out sc_logic 1 signal 1 } 
	{ MatA_d0 sc_out sc_lv 2400 signal 1 } 
	{ MatA_address1 sc_out sc_lv 7 signal 1 } 
	{ MatA_ce1 sc_out sc_logic 1 signal 1 } 
	{ MatA_q1 sc_in sc_lv 2400 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "MatA_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "MatA", "role": "we0" }} , 
 	{ "name": "MatA_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":2400, "type": "signal", "bundle":{"name": "MatA", "role": "d0" }} , 
 	{ "name": "MatA_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "MatA", "role": "address1" }} , 
 	{ "name": "MatA_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "MatA", "role": "ce1" }} , 
 	{ "name": "MatA_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":2400, "type": "signal", "bundle":{"name": "MatA", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8ns_7ns_8ns_14_4_1_U1", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15078", "Max" : "15078"}
	, {"Name" : "Interval", "Min" : "15078", "Max" : "15078"}
]}
...
set Spec2ImplPortList { 
	...
	MatA { ap_memory {  { MatA_address0 mem_address 1 7 }  { MatA_ce0 mem_ce 1 1 }  { MatA_we0 mem_we 1 1 }  { MatA_d0 mem_din 1 2400 }  { MatA_address1 MemPortADDR2 1 7 }  { MatA_ce1 MemPortCE2 1 1 }  { MatA_q1 MemPortDOUT2 0 2400 } } }
