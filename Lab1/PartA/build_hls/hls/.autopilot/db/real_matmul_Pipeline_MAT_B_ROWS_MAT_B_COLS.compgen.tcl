...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename MatB \
    op interface \
    ports { MatB_address0 { O 8 vector } MatB_ce0 { O 1 bit } MatB_we0 { O 300 vector } MatB_d0 { O 2400 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'MatB'"
}
}
